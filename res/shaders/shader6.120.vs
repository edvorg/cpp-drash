...
void main(void)
{
	...
	aViewDirTangent = vec3(tangent.x * viewDir.x + tangent.y * viewDir.y + tangent.z * viewDir.z,
		               binormal.x * viewDir.x + binormal.y * viewDir.y + binormal.z * viewDir.z, 
		     	       normal.x * viewDir.x + normal.y * viewDir.y + normal.z * viewDir.z);

	aLight1PosTangent = vec3(tangent.x * light1Dir.x + tangent.y * light1Dir.y + tangent.z * light1Dir.z,
	...
	aLight1Direction = vec3(tangent.x * gLight1Direction.x + tangent.y * gLight1Direction.y + tangent.z * gLight1Direction.z,
