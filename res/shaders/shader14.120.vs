...
/// Dual-light variant of shader7. Used by the "powerless" test scene
/// (test14) so the player carries a localised white torch while the
/// emergency lamps cast a coloured area light at the same time. Other
/// tests use shader7 and are unaffected.
