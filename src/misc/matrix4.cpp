...
namespace drash {
    ...
    CVec4f& MatrixMultiply(const CMatrix4f& _m, const CVec4f& _v,
        ...
        _result.mY = _v.mX * _m.mData[_m.m10] + _v.mY * _m.mData[_m.m11] +
                     _v.mZ * _m.mData[_m.m12] + _v.mW * _m.mData[_m.m13];

        _result.mZ = _v.mX * _m.mData[_m.m20] + _v.mY * _m.mData[_m.m21] +
                     _v.mZ * _m.mData[_m.m22] + _v.mW * _m.mData[_m.m23];

        _result.mW = _v.mX * _m.mData[_m.m30] + _v.mY * _m.mData[_m.m31] +
                     _v.mZ * _m.mData[_m.m32] + _v.mW * _m.mData[_m.m33];
